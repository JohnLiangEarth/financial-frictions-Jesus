...
load '../../2_model_LR/z_FinalWorkspace.mat' Y Y_fit;
Y_errors_LR = Y-Y_fit;
...
print -depsc g20_PLMerrors
savefig(myfig,'g20_PLMerrors.fig');
...
plot(B_bsss ,N_bsss,'ro')
plot(B3 ,N3,'ro')
text(B_llsss,N_llsss,'"Low leverage SSS" $\rightarrow$', 'interpreter','latex','HorizontalAlignment','right','FontSize',12)
text(B_bsss ,N_bsss,'"Baseline SSS" $\rightarrow$', 'interpreter','latex','HorizontalAlignment','right','FontSize',12)
...
print -dpdf g34_zone_2D
print -depsc g34_zone_2D
savefig(myfig,'g34_zone_2D.fig');
...
print -depsc g35_zone_3D
savefig(myfig,'g35_zone_3D.fig');

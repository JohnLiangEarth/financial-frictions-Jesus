...
load_PLM       = 'load ''../z1_085/z_FinalWorkspace.mat'' PLM PLM_2 PLM_finegrid PLM_finegrid_2 PLM_visits;';
...
maxitHJB = 600;                             % max number of iterations for the HJB
weHJB=0.272;

Bmin=0.151428571428571;
Bmax=1.61714285714286;
Nmin=2.4;
Nmax=3.81333333333333;

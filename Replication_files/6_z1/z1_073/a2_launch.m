...
load_PLM       = 'load    ''../../3_model_NN/z_FinalWorkspace.mat'' PLM PLM_2 PLM_finegrid PLM_finegrid_2 PLM_visits;';
load_LR_errors = 'load ''../../../2_model_LR/z_FinalWorkspace.mat'' Y Y_fit;';

z1=0.73;
z2            = 1 + la2/la1 * (1-z1);

maxitHJB = 400;                             % max number of iterations for the HJB
weHJB=0.49;

Bmin=0.663888888888889;
Bmax=2.63194444444445;
Nmin=1.31111111111111;
Nmax=3.25555555555556;

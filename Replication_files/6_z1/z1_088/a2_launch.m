...
load_PLM       = 'load ''../z1_087/z_FinalWorkspace.mat'' PLM PLM_2 PLM_finegrid PLM_finegrid_2 PLM_visits;';
...
maxitHJB = 800;                             % max number of iterations for the HJB
weHJB=0.208;

Bmin=0.114285714285714;
Bmax=1.57142857142857;
Nmin=2.6;
Nmax=3.87555555555556;
